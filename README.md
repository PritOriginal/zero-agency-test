...
> [!NOTE]  
> Реализовано две версии приложения: с использованием официальной библиотеки [`openai/openai-go`](https://github.com/openai/openai-go) (`bot-openai`) и без (`bot-http`).

> [!NOTE]  
> `bot-http` является более легковесной версией приложения.
